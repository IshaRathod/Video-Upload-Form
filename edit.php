...
<body>
    <div class="form-container">
        ...
        <form action="data_task.php" method="post" enctype="task/">
            ...
            <input type="email" id="email" name="email" placeholder="ex:- abc@gmail.com" value="<?php echo $row['email']; ?>">

            <label for="videoFile">Upload Video</label>
            <div class="file-upload">
                <input type="file" name="videoFile" id="videoFile" accept="video/*" required value="<?php echo $row['videoFile']; ?>">
            ...
            <input type="radio" id="html" name="agreement" value="Yes, I Do" value="<?php echo $row['agreement']; ?>">
            <label for="html" class="labelbox" >Yes, I Do</label><br>
            <input type="radio" id="css" name="agreement" value="No, I Don't" value="<?php echo $row['agreement']; ?>"> 
            <label for="css" class="labelbox">No, I Don't</label><br>
            

            <label for="comments">Comments:</label>
            <textarea id="comments" rows="4" name="comments" placeholder="Type here..." value="<?php echo $row['comments']; ?>"></textarea>
